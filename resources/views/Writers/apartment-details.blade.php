    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                ...
                <!-- Apartment Details -->
                <div class="card mb-4">
                    <img src="{{ asset('imagename/' . $booking->mainImage) }}"
                         class="card-img-top rounded-top img-fluid" alt="Apartment Image">
                    <div class="card-body">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <!-- Image Upload Form -->
                        <form action="{{route('ApartmentImages', ['id'=>  $booking->id])}}" method="POST"
                            ...
                            <button type="submit" class="btn btn-primary"><i class="fa fa-upload"></i> Upload Images
                            </button>
                        </form>
                                ...
                                <div class="carousel-inner">
                                    @foreach($images as $key => $image)
                                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                            <img src="{{ asset('ApartmentImages/' . $image->image) }}"
                                                 class="d-block w-100 img-fluid" style="max-height: 400px;"
                                                 alt="Apartment Image">
                                        </div>
                                    @endforeach
                                </div>
